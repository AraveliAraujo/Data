...
import controlador.AreasFacade;
...
public class AreasController implements Serializable {
    ...
    @EJB
    private controlador.AreasFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("AreasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("AreasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("AreasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
